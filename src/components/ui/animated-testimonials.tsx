          ...
          <div className="relative h-80 w-full">
            <AnimatePresence>
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <Compare
                    firstImage={testimonial.before}
                    secondImage={testimonial.after}
                    firstImageClassName="object-cover object-left-top"
                    secondImageClassname="object-cover object-left-top"
                    className="h-[250px] w-[200px] md:h-[400px] md:w-[400px] h-full w-full rounded-3xl object-cover object-center"
                    slideMode="hover"
                  />
                </motion.div>
              ))}
